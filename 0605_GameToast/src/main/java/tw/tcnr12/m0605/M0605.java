...
//            switch (iComPlay){
//                case 1:txtComPlay.setText(R.string.m0605_b001); //電腦出剪刀
//
//                    break;
//                case 2:txtComPlay.setText(R.string.m0605_b002);//電腦出石頭
//
//                    break;
//                case 3:txtComPlay.setText(R.string.m0605_b003);//電腦出布
//
//                    break;
//            }
...
//                            answer = getString(R.string.m0605_f000) + " " + getString(R.string.m0605_f003); //判斷結果
//                            txtResult.setTextColor(Color.YELLOW); //更改字體顏色
                            music ( 2 );
                            break;
                        case 2:
                            txtComPlay.setImageResource(R.drawable.stone);//電腦出石頭
//                            answer = getString(R.string.m0605_f000) + " " + getString(R.string.m0605_f002);//判斷結果
//                            txtResult.setTextColor(Color.RED);
                            music ( 3 );
                            break;
                        case 3:
                            txtComPlay.setImageResource(R.drawable.net);//電腦出布
//                            answer = getString(R.string.m0605_f000) + " " + getString(R.string.m0605_f001);//判斷結果
